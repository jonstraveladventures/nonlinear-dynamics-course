...
(where here $x_{1} \text{ is } \Theta{}$ and $x_{2} \text{ is }$ $\dot{\Theta{}}$). We never took into account the fact that Θ is periodic (though $\overset{ \bullet{}}{\Theta{}}$ is of course not) - ie $\Theta{}+2\Pi{} \text{ is } \text{ identified } \text{ with } \Theta{}$. The way we should do this is to acknowledge that the phase plane shouldn ’t be ${\mathbb{R}}^{2}$ but it should be ${\mathbb{R}}^{1}\times{}S^{1}$ - ie a cylinder.
...
$$
\overset{ \bullet{}}{\Theta{}}=f(\Theta{}) \text{ with } \text{ identification } \Theta{}+2\Pi{}\sim{}\Theta{}
$$
...
$$
\overset{ \bullet{}   }{{\Theta{}}_{1}}={\Omega{}}_{1}+K_{1}\text{ sin }({\Theta{}}_{2}-{\Theta{}}_{1})
$$
$$
\overset{ \bullet{}   }{{\Theta{}}_{2}}={\Omega{}}_{2}+K_{2}\text{ sin }({\Theta{}}_{1}-{\Theta{}}_{2})
$$
Where ${\Omega{}}_{1}\text{ and } {\Omega{}}_{2} \text{ are } $the natural frequencies of the motion (ie. without the $K_{i} \text{ terms }$ we would just have ${\Theta{}}_{i} \text{ going }$ around a circle at frequency ${\Omega{}}_{i}$), and $K_{i} \text{ are }$ coupling constants. We see then that when ${\Theta{}}_{1} \text{ and } {\Theta{}}_{2}$ are very close to each other, or differ by Π, the couplings are small, and when they differ by $\frac{\Pi{}}{2} \text{ or } \frac{3\Pi{}}{2}$ the couplings are large. This system wants to keep the ${\Theta{}}_{i} \text{ close } \text{ to } $each other, or exactly out of phase. Both the ${\Theta{}}_{i} \text{ live }$ on a circle. We can plot them on the same circle and see their trajectory. For instance if we start with ${\Omega{}}_{1}=1$, ${\Omega{}}_{2}=5$ and both $K_{i}=1 $we get:
...
$$
\overset{ \bullet{}   }{{\Theta{}}_{1}}=f_{1}({\Theta{}}_{1},{\Theta{}}_{2})
$$
$$
\overset{ \bullet{}   }{{\Theta{}}_{2}}=f_{2}({\Theta{}}_{1},{\Theta{}}_{2})
$$
...
$$
\overset{ \bullet{}   }{{\Theta{}}_{1}}=1
$$
$$
\overset{ \bullet{}   }{{\Theta{}}_{2}}=1
$$
...
Plotting this on the $({\Theta{}}_{1},{\Theta{}}_{2}) \text{ plane } \text{ we } \text{ have }$:
...
$$
\overset{ \bullet{}   }{{\Theta{}}_{1}}={\Omega{}}_{1}
$$
$$
\overset{ \bullet{}   }{{\Theta{}}_{2}}={\Omega{}}_{2}
$$
where $\frac{{\Omega{}}_{1}}{{\Omega{}}_{2}}=\frac{p}{q}\in{}\mathbb{Q}, $where $p\text{\textbackslash[Perpendicular]}q$, then the system will be periodic. What will the period be? Well, the period of the first cycle is $\frac{2\Pi{}}{{\Omega{}}_{1}} $and that of the second is $\frac{2\Pi{}}{{\Omega{}}_{2}}$. We want to find the lowest positive T such that T=$\frac{2 \Pi{}}{{\Omega{}}_{1}}p=\frac{2\Pi{}}{{\Omega{}}_{2}}q$ for $q,p\in{}$ ℤ. In the example above, we had:
$$
...
$$
\overset{ \bullet{}   }{{\Theta{}}_{1}}-\overset{ \bullet{}   }{{\Theta{}}_{2}}={\Omega{}}_{1}-{\Omega{}}_{2}+K_{1}\text{ sin }({\Theta{}}_{2}-{\Theta{}}_{1})-K_{2}\text{ sin }({\Theta{}}_{1}-{\Theta{}}_{2})
$$
So now we can define a new variable $\Phi{}={\Theta{}}_{1}-{\Theta{}}_{2}$ and rewrite this equation as:
$$
\overset{ \bullet{}   }{\Phi{}}=({\Omega{}}_{1}-{\Omega{}}_{2})+K_{1}\text{ sin }(-\Phi{})-K_{2}\text{ sin }(\Phi{})=({\Omega{}}_{1}-{\Omega{}}_{2})-(K_{1}+K_{2})\text{ sin }(\Phi{})
$$
$$
\overset{ \bullet{}   }{\Phi{}}=({\Omega{}}_{1}-{\Omega{}}_{2})-(K_{1}+K_{2})\text{ sin }(\Phi{})
$$
...
This system is known as the non-uniform oscillator. Remember, given that Φ is the difference between the ${\Theta{}}_{i}$ and the coupling only becomes important when the ${\Theta{}}_{i} \text{ are } \text{ far } \text{ apart } $(difference far away from 0 or Π), this equation makes sense.
...
$$
0=({\Omega{}}_{1}-{\Omega{}}_{2})-(K_{1}+K_{2})\text{ sin }(\Phi{})  \text{\textbackslash[DoubleLongRightArrow]} \text{ sin }(\Phi{}) =\frac{({\Omega{}}_{1}-{\Omega{}}_{2})}{(K_{1}+K_{2})}
$$
...
$$
\overset{ \bullet{}   }{{\Theta{}}_{1}}={\Omega{}}_{1}-K_{1}\text{ sin }({\Phi{}}^{*})={\Omega{}}_{1}-K_{1}\frac{{\Omega{}}_{1}-{\Omega{}}_{2}}{K_{1}+K_{2}}=\frac{K_{2}{\Omega{}}_{1}+K_{1}{\Omega{}}_{2}}{K_{1}+K_{2}}
$$
$$
\overset{ \bullet{}   }{{\Theta{}}_{2}}={\Omega{}}_{2}+K_{2}\text{ sin }({\Phi{}}^{*})={\Omega{}}_{2}-K_{2}\frac{{\Omega{}}_{1}-{\Omega{}}_{2}}{K_{1}+K_{2}}=\frac{K_{2}{\Omega{}}_{1}+K_{1}{\Omega{}}_{2}}{K_{1}+K_{2}}
$$
...
$$
$$
\overset{ \bullet{}   }{{\Theta{}}_{2}}=K_{2}\text{ sin }({\Theta{}}_{1}-{\Theta{}}_{2})
$$
...
$$
\overset{ \bullet{}   }{{\Theta{}}_{1}}=1+0.1\text{ sin }({\Theta{}}_{2}-{\Theta{}}_{1}), {\Theta{}}_{1}(0)=0
$$
$$
\overset{ \bullet{}   }{{\Theta{}}_{2}}=3+10\text{ sin }({\Theta{}}_{1}-{\Theta{}}_{2}), {\Theta{}}_{2}(0)=2
$$
